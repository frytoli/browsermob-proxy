...
public interface BrowserMobProxy {
     ...
     *
     * @param chainedProxyType address of the upstream proxy
     * @param chainedProxyAddress address of the upstream proxy
     * @param chainedProxyUsername address of the upstream proxy
     * @param chainedProxyPassword address of the upstream proxy
     */
